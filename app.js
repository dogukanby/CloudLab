(function(){
    ...
    en: {
      ...
      services:{
        ...
        items:{
          ...
          sts:"Security Token Service — hands out short-lived temporary credentials for assuming a role, so nobody carries permanent keys.",
          iamidc:"Single sign-on for your workforce — one login that works across every account and connected app.",
          cognito:"Sign-up and sign-in for your app's end users — user pools, social logins, and tokens, so you never build auth yourself.",
          inspector:"Automatically scans instances, container images, and functions for known vulnerabilities (CVEs) and ranks what to patch first.",
          securityhub:"One dashboard that aggregates findings from all the other security tools and scores you against best-practice standards.",
          kms:"Creates and controls the encryption keys protecting your data — you decide who can use which key, and every use is logged.",
          cloudhsm:"A dedicated, single-tenant hardware security module — for regulated workloads whose keys can't share hardware with anyone.",
          secretsmanager:"Stores database passwords, API keys, and tokens centrally — apps fetch them at runtime, rotation is automatic, and secrets never live in code.",
          acm:"Issues and automatically renews the TLS/SSL certificates that put the padlock on your domains.",
    ...
    tr: {
      ...
      services:{
        ...
        items:{
          ...
          sts:"Güvenlik Jetonu Servisi — rol üstlenmek için kısa ömürlü, geçici kimlik bilgileri dağıtır; kimse kalıcı anahtar taşımaz.",
          iamidc:"Çalışanlar için tek oturum açma (SSO) — tüm hesaplarda ve bağlı uygulamalarda geçerli tek giriş.",
          cognito:"Uygulamanızın son kullanıcıları için kayıt ve giriş — kullanıcı havuzları, sosyal girişler ve jetonlar; kimlik doğrulamayı kendiniz yazmazsınız.",
          inspector:"Sunucuları, konteyner imajlarını ve fonksiyonları bilinen açıklara (CVE) karşı otomatik tarar, önce neyin yamalanacağını sıralar.",
          securityhub:"Diğer tüm güvenlik araçlarının bulgularını tek panoda toplar ve sizi en-iyi-uygulama standartlarına göre puanlar.",
          kms:"Verinizi koruyan şifreleme anahtarlarını üretir ve yönetir — hangi anahtarı kimin kullanacağına siz karar verirsiniz, her kullanım loglanır.",
          cloudhsm:"Size özel, tek kiracılı donanım güvenlik modülü — anahtarları kimseyle donanım paylaşamayacak regüle iş yükleri için.",
          secretsmanager:"Veritabanı parolalarını, API anahtarlarını ve jetonları merkezde saklar — uygulamalar çalışırken çeker, rotasyon otomatiktir, sır asla koda yazılmaz.",
          acm:"Alan adlarınıza kilit simgesini koyan TLS/SSL sertifikalarını üretir ve otomatik yeniler.",
  ...
  const SERVICE_DIRECTORY=[
    ...
    { id:"sts", cat:"security", aws:"AWS STS", azure:"Entra ID Token Service", gcp:"Security Token Service" },
    { id:"iamidc", cat:"security", aws:"IAM Identity Center (SSO)", azure:"Microsoft Entra ID", gcp:"Cloud Identity" },
    { id:"cognito", cat:"security", aws:"Amazon Cognito", azure:"Entra External ID (B2C)", gcp:"Identity Platform" },
    { id:"guardduty", cat:"security", aws:"Amazon GuardDuty", azure:"Microsoft Defender for Cloud", gcp:"Security Command Center" },
    { id:"inspector", cat:"security", aws:"Amazon Inspector", azure:"Defender Vulnerability Management", gcp:"Web Security Scanner" },
    { id:"securityhub", cat:"security", aws:"AWS Security Hub", azure:"Microsoft Defender for Cloud", gcp:"Security Command Center" },
    ...
    { id:"kms", cat:"security", aws:"AWS KMS", azure:"Azure Key Vault (keys)", gcp:"Cloud KMS" },
    { id:"cloudhsm", cat:"security", aws:"AWS CloudHSM", azure:"Azure Dedicated HSM", gcp:"Cloud HSM" },
    { id:"secretsmanager", cat:"security", aws:"AWS Secrets Manager", azure:"Azure Key Vault (secrets)", gcp:"Secret Manager" },
    { id:"acm", cat:"security", aws:"AWS Certificate Manager", azure:"Key Vault Certificates", gcp:"Certificate Manager" },
